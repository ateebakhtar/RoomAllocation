...
public class ExtraClassConnection extends AsyncTask<Void,Void,Void>
{
    String ID;
    String course;
    String section;
    int day;
    String instructor;
    public ExtraClassConnection(Context context, String course, String section, int day,String instructor)  {
        this.cx = context;
        this.course = course;
        this.day = day;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        Call<TimetableData> call = GDS.extraclass(course,section,day,instructor);
        Response<TimetableData> x = null;
        try
        {
            x = call.execute();
