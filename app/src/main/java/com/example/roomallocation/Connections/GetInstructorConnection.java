...
public class GetInstructorConnection extends AsyncTask<Void,Void,Void>
{
    String ID;
    public GetInstructorConnection(Context context)  {
        this.cx = context;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        Call<ArrayList<String>> call = GDS.GetInstructor();
        Response<ArrayList<String>> x = null;
        try
        {
            x = call.execute();
            System.out.println(x.body());
            Data.taechers = x.body();
            //Data.m = x.body();
        }
        catch (IOException e)
        {
