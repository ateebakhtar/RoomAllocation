...
public class TeacherMain extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(view.getContext(),TeacherList.class);
                startActivity(i);
            }
        });
        ...
        semester.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    case 0:
                        ArrayAdapter adapter2 = new ArrayAdapter<String>(TeacherMain.this,android.R.layout.simple_list_item_1,x);
                        courses.setAdapter(adapter2);

                        break;
                    case 1:
                        String[] x1 = getResources().getStringArray(R.array.s2);
                        ArrayAdapter adapter3 = new ArrayAdapter<String>(TeacherMain.this,android.R.layout.simple_list_item_1,x1);
                        courses.setAdapter(adapter3);
                        break;
                    case 2:
                        String[] x2 = getResources().getStringArray(R.array.s3);
                        ArrayAdapter adapter4 = new ArrayAdapter<String>(TeacherMain.this,android.R.layout.simple_list_item_1,x2);
                        courses.setAdapter(adapter4);
                        break;
                    case 3:
                        String[] x3 = getResources().getStringArray(R.array.s4);
                        ArrayAdapter adapter5 = new ArrayAdapter<String>(TeacherMain.this,android.R.layout.simple_list_item_1,x3);
    ...
    public void openextraclass(View view)
    {
